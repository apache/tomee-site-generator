...
You can have as many of these test beans in your test code as you like, each with its own transaction and security constraints allowing you to write some incredibly thorough tests.
