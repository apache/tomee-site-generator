...
Definitely give those a look at:  https://svn.apache.org/viewvc/tomee/tomee/trunk/itests/
...
https://maven.apache.org/plugins-sandbox/itest/
...
See this document for more info:  https://maven.apache.org/guides/introduction/introduction-to-the-lifecycle.html
