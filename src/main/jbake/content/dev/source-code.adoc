...
You can browse the source code via the https://gitbox.apache.org/repos/asf/tomee.git[web interface].
...
Apache TomEE continuous integration relies on https://ci.apache.org/[Apache Buildbot].
All builders are available https://ci.apache.org/builders[from the page].

* https://ci.apache.org/builders/tomee-1.7.x-ubuntu[Apache TomEE 1.7.x under Ubuntu]
* https://ci.apache.org/builders/tomee-trunk-ubuntu[Apache TomEE 2.x under Ubuntu]
* https://ci.apache.org/builders/tomee-trunk-win-sunjdk[Apache TomEE 2.x under Windows using a Sun/Oracle JDK]
* https://ci.apache.org/builders/tomee-trunk-win-ibmjdk6[Apache TomEE 2.x under Windows using an IBM JDK]

== Maven

To build the code, you'll need to grab a copy of https://maven.apache.org[Apache Maven], version 3.0.5 or later.
