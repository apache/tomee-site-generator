...
Likely more true is that if it isn't tested it might as well not exist, documentation or not.

The simple truth is many of the critical tests that apply to functionality in TomEE actually exist, but are spread across the numerous projects that TomEE incorporates.
Just as TomEE is about unifying and integrating all these projects together, the same vision and initiative must be given into unifying and integrating all these tests.
...
There are far more than 3,000 test classes we could port across the various projects, each using its own flavor of home-made setup code.
...
* svn co https://svn.apache.org/repos/asf/activemq/trunk
* svn co https://svn.apache.org/repos/asf/bval/trunk
* svn co https://svn.apache.org/repos/asf/cxf/trunk
* svn co https://svn.apache.org/repos/asf/myfaces/core/trunk
* svn co https://svn.apache.org/repos/asf/tomee/tomee/trunk/itests
* svn co https://svn.apache.org/repos/asf/openjpa/branches/2.2.x
* svn co https://svn.apache.org/repos/asf/openwebbeans/trunk
* svn co https://svn.apache.org/repos/asf/tomcat/tc7.0.x/trunk

While not part of TomEE, Wink has some wonderful JAX-RS tests we could use:

* svn co https://svn.apache.org/repos/asf/wink/trunk
