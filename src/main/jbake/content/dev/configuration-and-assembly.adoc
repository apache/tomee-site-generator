...
Here's a test that builds OpenEJB using its internal API.
...
The runtime system gets top priority on its architectural needs and the assembler gets last priority.
