...
link:https://tomee.apache.org/9.0.0/microprofile-5.0.html[Apache TomEE 9.0.0 TCK results]
...
For more details on the complete execution, the logs are available in https://ci-builds.apache.org/job/Tomee/job/TomEE_Compitable_TCK/3/[Jenkins]
