...
=== Apache TomEE 9.1.2 , MicroProfile 5.0 TCK Certification Summary
----
Date:  December 12, 2023
Product Name, Version: Apache TomEE 9.1.2
...
link:https://tomee.apache.org/9.1.2/microprofile-5.0.html[Apache TomEE 9.1.0 TCK results]
